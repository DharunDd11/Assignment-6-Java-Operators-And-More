public class ArrayWith_Objects {

    String message;

    ArrayWith_Objects(String message) {
    ...
    public static void main(String[] args) {
        ...
        ArrayWith_Objects[] arr = new ArrayWith_Objects[5];
        ...
        arr[0] = new ArrayWith_Objects("Object 1");
        arr[1] = new ArrayWith_Objects("Object 2");
        arr[2] = new ArrayWith_Objects("Object 3");
        arr[3] = new ArrayWith_Objects("Object 4");
        arr[4] = new ArrayWith_Objects("Object 5");
